...
actor GraphQLClient {
    ...
    private func makeRequest<V: Encodable & Sendable>(query: String, variables: V) throws -> URLRequest {
        ...
        do {
            ...
            Logger.digitransit.error("GraphQL encode failed error=\(String(describing: error), privacy: .private)")
    ...
    private func throwIfGraphQLErrors(in data: Data) throws {
        ...
        Logger.digitransit.error("GraphQL errors: \(message, privacy: .private)")
